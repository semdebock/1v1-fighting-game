...
try{
 ...
 rep("Mysterio:{lesson:'", "Mysterio:{lesson:'ILLUSION CONTROL',tip:'Ignore the clone bait, track the real body and punish the smoke teleport recovery.',abilities:['Mystic Orb','Illusion Clone','Smoke Teleport'],reward:'900 🪙 • 180 XP'},\n 'Green Goblin':{lesson:'CHAOS MANAGEMENT',tip:'Stay unpredictable through Pumpkin Bomb pressure and counter when Norman overcommits.',abilities:['Pumpkin Bomb','Goblin Pressure','Aerial Assault'],reward:'1000 🪙 • 195 XP'},\n MysterioLegacy:{lesson:'", 'details insertion');
 // Undo the temporary helper key introduced only to locate the DETAILS insertion point.
 code=code.replace("MysterioLegacy:{lesson:'ILLUSION CONTROL',tip:'Ignore the clone bait, track the real body and punish the smoke teleport recovery.',abilities:['Mystic Orb','Illusion Clone','Smoke Teleport'],reward:'900 🪙 • 180 XP'},\n 'Green Goblin':{lesson:'CHAOS MANAGEMENT',tip:'Stay unpredictable through Pumpkin Bomb pressure and counter when Norman overcommits.',abilities:['Pumpkin Bomb','Goblin Pressure','Aerial Assault'],reward:'1000 🪙 • 195 XP'},\n Mysterio:{lesson:'", "Mysterio:{lesson:'");
