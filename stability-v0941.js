...
(() => {
 ...
 const selector='#mystClone,.projectile,.impact,.blockfx,.ko-banner,.callout,.smoke,.wave,.divine-nova,.omni-warp,.absolute-decree,.dd-grapple,.khonshu-flash,.nano-arsenal,.bp-clawfx,.wolverine-slash,.berserker-rage,.kinetic-release,.kinetic-overdrive,.fighter-intro,.boss-intro';
 const cleanup=()=>arena.querySelectorAll(selector).forEach(n=>n.remove());
