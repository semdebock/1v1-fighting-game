...
const DETAILS={
 ...
 Sabretooth:{lesson:'SURVIVE THE HUNT',tip:'Creed will stay on top of you. Break his feral pressure and keep attacking often enough that his capped regeneration cannot undo your work.',abilities:['Feral Slash','Predator Leap','Savage Rush','Apex Hunter','Healing Factor'],reward:'950 🪙 • 185 XP'},
 Mystique:{lesson:'FIGHT YOUR OWN SHADOW',tip:'Raven starts in her iconic blue form, then transforms into your selected fighter around mid-health. Adapt when your own strengths come back at you.',abilities:['Pistol Burst','Acrobatic Strike','Identity Shift','Mirror Attack','Identity Theft'],reward:'1100 🪙 • 210 XP'},
 Juggernaut:{lesson:'MOVE THE MOUNTAIN',tip:'Juggernaut is enormous and armored. Step out of the charge lane; his armor briefly opens after committed attacks and missed momentum.',abilities:['Helmet Bash','Unstoppable Charge','Ground Breaker','I’m the Juggernaut'],reward:'1300 🪙 • 240 XP'},
 Deadpool:{lesson:'FINISH HIM TWICE',tip:'Wade heals whenever you give him breathing room and has one guaranteed Last Stand. Stay composed through the chaos and finish the second health push.',abilities:['Dual Pistols','Katana Rush','Combat Roll','Healing Factor','Maximum Effort'],reward:'1450 🪙 • 260 XP'},
