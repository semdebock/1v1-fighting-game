...
for(const stable of ["const BUILD='0.9.6.3'","const ASSET='0963'","const SAVE_KEY='fightArenaV08'","'touch-v0941.js'","'stability-v0941.js'","'campaign-v0957.js'","'polish-v09572.js'","'premium-v096.js'","'update-v0962.js'","'update-v0963.js'"])if(!boot.includes(stable))throw new Error('v0.9.6.3 stable bootstrap marker missing: '+stable);
console.log('v0.9.6.3 premium compatibility checks passed');
