...
for(const stable of ["const BUILD='0.9.7.4'","const ASSET='0974'","const SAVE_KEY='fightArenaV08'","'campaign-v097.js'","'update-v097.js'","'update-v0971.js'","'update-v0972.js'","'update-v0973.js'","'update-v0974.js'"])if(!boot.includes(stable))throw new Error('v0.9.7.4 bootstrap marker missing: '+stable);
for(const marker of ['window.MultiverseArenaUpdate0973','decorateCards','updateDaily','const ownsRelease='])if(!update973.includes(marker))throw new Error('v0.9.7.3 compatibility marker missing: '+marker);
for(const marker of ['window.MultiverseArenaUpdate0974','Hulkbuster • 250 Diamonds • Veronica Crashdown','decorateHulkbuster','updateFighterStats'])if(!update974.includes(marker))throw new Error('v0.9.7.4 release UI marker missing: '+marker);
...
console.log('v0.9.7.4 premium compatibility checks passed');
