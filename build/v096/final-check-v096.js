...
for(const legacy of [update62,update63,update64,update97,update971,update972,update973,update974,update9741,update975,update9751,update976])if(!legacy.includes('const ownsRelease='))throw new Error('release layer can overwrite newer branding');
for(const stable of ["const SAVE_KEY='fightArenaV08'","'campaign-v097.js'","'update-v097.js'","'update-v0971.js'","'update-v0972.js'","'update-v0973.js'","'update-v0974.js'","'update-v09741.js'","'update-v0975.js'","'update-v09751.js'","'update-v0976.js'"])if(!boot.includes(stable))throw new Error('current bootstrap compatibility marker missing: '+stable);
...
for(const marker of ['window.MultiverseArenaUpdate0976','decorateCollection','decorateGauntlet','Phase Mastery','True Boss Diamonds','const ownsRelease='])if(!update976.includes(marker))throw new Error('v0.9.7.6 release UI marker missing: '+marker);
