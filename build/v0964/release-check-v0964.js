...
for(const marker of ["const BUILD='0.9.6.4'","const ASSET='0964'","const SAVE_KEY='fightArenaV08'","'update-v0964.js'"])if(!boot.includes(marker))throw new Error('v0.9.6.4 bootstrap marker missing: '+marker);
for(const marker of ['visualViewport','--fight-viewport-v0964','composeFightTopbar','fighthead-emptied-v0964','fight-control-label-v0963','v0.9.6.4','iPad Control Fit • Centered Preview • UI Audit','cleanUpdateLog'])if(!ui.includes(marker))throw new Error('v0.9.6.4 runtime marker missing: '+marker);
...
console.log('v0.9.6.4 iPad fit + UI audit checks passed');
