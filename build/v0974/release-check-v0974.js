...
for(const marker of ["t974=require('../v0974/transform-v0974.js')",'t974(t973(','patch:\'0.9.7.4\''])if(!buildCore.includes(marker))throw new Error('v0.9.7.4 core-build marker missing: '+marker);
